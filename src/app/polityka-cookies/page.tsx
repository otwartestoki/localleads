      ...
      sections={[
        ...
        },
        {
          ...
          items: [
            ...
            'cookies analityczne — pomagają zrozumieć, jak użytkownicy korzystają ze strony; są uruchamiane tylko wtedy, gdy użytkownik wyrazi zgodę,',
        ...
        },
        {
          ...
          paragraphs: [
            ...
            'Użytkownik może w dowolnym momencie zmienić ustawienia cookies w przeglądarce. Strona zapisuje decyzję użytkownika w localStorage pod kluczem localleads-cookie-consent-v1 i udostępnia baner zgody z możliwością akceptacji wszystkich, odrzucenia opcjonalnych lub wyboru kategorii cookies.',
          ],
        },
        {
